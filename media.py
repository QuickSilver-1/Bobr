...
egypt1_text = "С древних времен человечеству были известны 5 основных способов отбеливания зубов: абразивными материалами, кислотой, известью и другими"
...
chemicals1_text = "В современных реалиях используются разные способы отбеливания зубов с применением химических средств"
...
quiz_introduction_text = "А теперь давай пройдём викторину, в конце которой ты сможешь получить промокод на скидку для покупки продукции BIOMED"
